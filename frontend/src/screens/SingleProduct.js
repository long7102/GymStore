...
const SingleProduct = ({ history, match }) => {
  ...
  useEffect(() => {
    if (successCreateReview) {
      alert("Đánh giá sản phẩm thành công")
      setRating(0)
      setComment("")
          ...
          loading ? (
            ...
            <>
                    ...
                    <div className="product-count col-lg-7 ">
                      ...
                      <div className="flex-box d-flex justify-content-between align-items-center">
                        ...
                        <Rating
                          ...
                          text={`${product.numReviews} đánh giá`}
                        />
                      </div>
                      {product.countInStock > 0 ? (
                        <>
                          ...
                          <button onClick={AddToCartHandler} className="round-black-btn">Thêm vào giỏ hàng</button>
                        </>
                      ) : null}
                    </div>
                  </div>
              ...
              <div className="row my-5">
                <div className="col-md-6">
                  <h6 className="mb-3">Đánh giá</h6>
                  {product.reviews.length === 0 && (
                    <Message variant={"alert-info mt-3"}>Chưa có Review nào</Message>
                  )}
                  {
                ...
                <div className="col-md-6">
                  <h6>Đánh giá của khách hàng</h6>
                  <div className="my-4">
                      ...
                      <form onSubmit={submitHandler}>
                        <div className="my-4">
                          ...
                          <select value={rating} onChange={(e) => setRating(e.target.value)} className="col-12 bg-light p-3 mt-2 border-0 rounded">
                            ...
                            <option value="1">1 - Tệ</option>
                            <option value="2">2 - Bình thường</option>
                            <option value="3">3 - Tốt</option>
                            <option value="4">4 - Rất tốt</option>
                            <option value="5">5 - Hoàn hảo</option>
                          </select>
                        </div>
                        <div className="my-4">
                          <strong>Bình luận</strong>
                          <textarea
                            row="3"
                            value={comment}
