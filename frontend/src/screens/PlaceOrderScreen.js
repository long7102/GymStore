          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Địa chỉ nhận hàng: {cart.shippingAddress.address}</p>
                <p>Số điện thoại:  {cart.shippingAddress.phone}</p>
                <p>Phương thức thanh toán: {cart.paymentMethod}</p>
              </div>
            </div>
          </div>
          {/* 3 */}
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>
                  Địa chỉ: {cart.shippingAddress.address}, {cart.shippingAddress.city}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-8">
            {
              cart.cartItems.length === 0 ? (
                <Message variant="alert-info mt-5">Chưa có sản phẩm nào trong giỏ hàng</Message>
              )
                :
                (
                  <>
