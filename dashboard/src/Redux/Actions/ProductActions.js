...
//thêm mới san pham
export const createProduct = (name, price, brand, description, image, countInStock ) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.post(`/api/products/`, {name, price, brand, description, image, countInStock },config)
